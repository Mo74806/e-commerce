...
var fnameFlag, lnameFlag, creditNumberFlag, mailFlag;
//------------------------------form verfication--------------------------
...
creditNumber.addEventListener("change", function (e) {
  var feedback = document.querySelector(".credit-valid-feedback");
...
btn.addEventListener("click", function (e) {
  e.preventDefault();
  if ((fnameFlag, lnameFlag, creditNumberFlag, mailFlag) && cart.length) {
    var purchesForm = document.querySelector("#form");
    purchesForm.innerHTML = "";
  ...
  <p id="success-message">thank you for buying from us.</p></div>
  </div>`
    );
  } else {
